  ...
  return (
    <>
      <div className="fixed bottom-0 left-0 w-full z-[90] md:w-[76px] md:h-screen md:top-0 pointer-events-none pb-safe flex justify-center md:block">
        <nav className="w-full max-w-[640px] md:w-full md:h-full bg-white/90 dark:bg-[#101010]/90 backdrop-blur-xl border-t md:border-t-0 md:border-r border-gray-200 dark:border-[#222] flex md:flex-col items-center justify-between md:justify-between px-6 sm:px-10 md:px-0 md:py-8 h-[68px] md:h-auto pointer-events-auto">
      ...
      {user && <CreatePostModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} onSubmit={handleAddNewPost} userName={currentUserName} userAvatar={currentUserAvatar} />}
